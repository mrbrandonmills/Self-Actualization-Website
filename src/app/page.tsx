 ...
 *
 * A cinematic journey through rooms of transformation
 * Wes Anderson aesthetics + Alexander McQueen drama
 * Real video backgrounds + CSS 3D book pedestals
 *
 * Architecture:
 * - Lenis smooth scroll (butter-smooth, 3KB)
 * - GSAP ScrollTrigger (scroll-synced animations)
 * - CSS 3D transforms (NO WebGL)
 * - AI-generated video backgrounds (Runway Gen-3 / Sora ready)
 */
          ...
          <div className="flex items-center justify-center h-full">
            <div className="text-center text-white">
              ...
              <button
                ...
                className="px-12 py-4 bg-white text-gray-900 rounded-full text-lg font-semibold hover:bg-gray-100 transition-all duration-300"
              >
                Return to Entrance
              </button>
            </div>
